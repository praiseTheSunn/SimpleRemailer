...
# from Module.schemas import EmailRequest, Message, DecryptedData, HeaderInfo
...
# from Module.Encryption.EncryptionManager import EncryptionManager
...
if __name__ == '__main__':
    uvicorn.run(app, host="127.0.0.1", port=8001)#, ssl_certfile="cert.pem", ssl_keyfile="key.pem")
